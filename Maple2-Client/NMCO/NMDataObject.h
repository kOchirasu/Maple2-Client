...
enum	NMLoginAuthReplyCode {	//	Reply code for login result to authentication server
  kLoginAuth_OK,									//	성공
...
enum	NMMessengerReplyCode {	// Result Code for Messenger Reply
  kMessengerReplyOK = 0,
